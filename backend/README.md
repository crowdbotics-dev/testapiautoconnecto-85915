...
## Project Structure
    ...
    ├── testapiautoconnecto_85915  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_85915`
...
2. Clone this repo and `cd testapiautoconnecto_85915`
